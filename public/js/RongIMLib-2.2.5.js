...
(function (RongIMLib) {
    var ServerDataProvider = (function () {
        ...
        ServerDataProvider.prototype.addToBlacklist = function (userId, callback) {
            ...
            RongIMLib.RongIMClient.bridge.queryMsg(21, RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()), RongIMLib.Bridge._client.userId, {
                onSuccess: function () {
                    callback.onSuccess();
                },
                onError: function () {
        ...
        ServerDataProvider.prototype.getBlacklistStatus = function (userId, callback) {
            ...
            modules.setUserId(userId);
            RongIMLib.RongIMClient.bridge.queryMsg(24, RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()), RongIMLib.Bridge._client.userId, {
        ...
        ServerDataProvider.prototype.removeFromBlacklist = function (userId, callback) {
            ...
            modules.setUserId(userId);
            RongIMLib.RongIMClient.bridge.queryMsg(22, RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()), RongIMLib.Bridge._client.userId, {
                onSuccess: function () {
                    callback.onSuccess();
                },
                onError: function () {
